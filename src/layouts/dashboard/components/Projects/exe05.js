...
function Projects05() {
  const codeString = `package br.com.ifgoiano.exe5;
    ...
    <Card>
      ...
      <Card>
        ...
        <SuiBox display="flex" justifyContent="space-between" alignItems="center" p={3}>
          <SuiBox>
            <SuiTypography variant="h6" gutterBottom>
              5. Escreva um programa que leia um número inteiro e exiba o seu módulo. O módulo de um
